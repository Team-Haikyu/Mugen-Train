    ...
    <body>
        ...
        <main>
            ...
            <div class="container marketing">
                <h1 style="text-align: center;font-weight: bolder;">My Profile</h1>
                <!-- Three columns of text below the carousel -->
                <div class="row" style="margin-top: 42px;">
                    <div class="col-md-6 col-md-offset-1">

                        
                        <div class="card" style="margin-top: 20px;box-shadow: 2px 6px 9px 4px black;">
                            <div class="card-header" style="background-color:aqua">
                              <img src="../../Images/notes.png" width="50" height="40" alt="">
                              <img src="../../Images/users.png" width="50" height="40" style="float: right ;"  alt="">
                            </div>
                            <div class="card-body">
                                ...
                                <a class="btn btn-danger" href="myTickets.php" style="float: right;">My Tickets</a>
                    ...
                    <div class="col-md-6 col-md-offset-1">
                        <img src="../../Images/profile.png" alt="" height="300px" width="350px" style="margin-left: 250px;">
                        <p  style="margin-left: 200px;margin-top: 16px;font-size: 20px;text-align: center;">Mamun Khan</p>
                    </div>
                </div>
                </div>
