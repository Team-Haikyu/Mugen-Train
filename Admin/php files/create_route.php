    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="card" style="margin:8%">
        <div class="card-header">
          <h3>Add Routes
          <img src="../../Images/tracks.png" style="float: right;" height="60px" width="60px" alt="">
          </h3>
        </div>
        <div class="card-body">
            <form  action="create_route.php" method="POST">
            <div class="form-group row"  style="margin-top: 15px;">
                    <label for="class" class="col-sm-2 col-form-label">Source</label>
                    <div class="col-sm-10">
                      <input type="text" name="source" class="form-control" id="class" placeholder="Source">
                    </div>
                  </div>
                  <div class="form-group row"  style="margin-top: 15px;">
                    <label for="class" class="col-sm-2 col-form-label">Destination</label>
                    <div class="col-sm-10">
                      <input type="text" name="dest" class="form-control" id="class" placeholder="Destination">
                    </div>
                  </div>
                  <div class="form-group row" style="margin-top: 15px;">
