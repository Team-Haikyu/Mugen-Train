  ...
  Logout
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"><i class='bx bxs-caret-up-circle'></i>
            &nbsp;Route Lists</h1>
      ...
      <table class="table table-striped">
        <thead>
          <tr>
            <th scope="col" style="background-color: aqua;">Route ID</th>
        ...
        <tbody >
          <tr >
            <td style="text-align: left;">150042</td>
            <td style="text-align: left;">Dhaka</td>
            <td style="text-align: left;">Sylhet</td>
            <td style="text-align: left;">Tk 534</td>
          </tr>
