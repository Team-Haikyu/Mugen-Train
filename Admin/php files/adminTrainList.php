  ...
  Logout
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"><i class='bx bxs-file'></i>
            &nbsp;Train Lists</h1>
      ...
      <table class="table table-striped">
        <thead>
          <tr>
            ...
            <th scope="col" style="background-color: aqua;">Train Name</th>
            <th scope="col" style="background-color: aqua;">Number of Blocks</th>
            <th scope="col" style="background-color: aqua;">Number of Seats</th>
          </tr>
        </thead>
        <tbody >
          <tr >
