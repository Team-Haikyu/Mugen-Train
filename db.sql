...
INSERT INTO SEATS(SEAT_NUM, TID, BID, CLASS) VALUES(1,1,1,'SHOVAN');
...
INSERT INTO ROUTE_TRAIN_JUNCTION(ROUTE_ID, TID, ARRIVAL_TIME, DEPARTURE_TIME) VALUES(1, 1000, '8.00 AM', '6.00 AM');
...
INSERT INTO TICKETS(TRAIN_ID, USER_ID, ROUTE_ID, TRAVEL_DATE, ARRIVAL_TIME, DEPARTURE_TIME, TRAIN_NAME, B_NAME, SEAT_NUM, CLASS, FARE)
            VALUES(1000, 21, 1, TO_DATE('12 AUG 2022', 'DD MON YYYY'), '8.00 AM', '6.00 AM', 'MUGEN', 'A', 23, 'AC', 200 );
